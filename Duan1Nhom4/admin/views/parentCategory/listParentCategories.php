...
<head>
    ...
    <title>listParentCategories</title>
    ...
    <div class="box-main">
        ...
        <div class="box-views">
            <div class="container">
                ...
                <a href="index.php?act=addParentCategory">Add Parent Category</a>
                <table>
                    <tr>
                        <th>ID</th>
                        <th>Name</th>
                    ...
                    <tr>
                        ...
                        <td><?= isset($parentCategory['parent_name']) ? $parentCategory['parent_name'] : 'N/A' ?></td>
                        <td>
                            <a href="index.php?act=editParentCategory&id=<?= $parentCategory['id'] ?>">Edit</a>
                            <a href="index.php?act=deleteParentCategory&id=<?= $parentCategory['id'] ?>">Delete</a>
                        </td>
                    </tr>
                    <?php endforeach; ?>
                </table>
