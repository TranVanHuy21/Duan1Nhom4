                        ...
                        <form action="?act=insertProduct" method="post" enctype="multipart/form-data">
                            <div class="form-group">
                                ...
                                <div>
                                    ...
                                    <input type="text" id="Camera_primary" name="Camera_primary" class="form-control">
                                    <span class="error-message" id="error-Camera_primary"></span>
                                </div>
                                <div>
                                    <label for="Camera_secondary" class="form-label">Camera sau</label>
                                    <input type="text" id="Camera_secondary" name="Camera_secondary" class="form-control">
                                ...
                                <div>
                                    ...
                                    <input type="text" id="Promotion_price" name="Promotion_price" class="form-control">
                                    <span class="error-message" id="error-Promotion_price"></span>
                                </div>
                                <div>
                                    <label for="Start_promotion" class="form-label">Ngày bắt đầu khuyến mãi</label>
                                    <input type="date" id="Start_promotion" name="Start_promotion" class="form-control">
                                    <span class="error-message" id="error-Start_promotion"></span>
                                </div>
                                <div>
                                    <label for="End_promotion" class="form-label">Ngày kết thúc khuyến mãi</label>
                                    <input type="date" id="End_promotion" name="End_promotion" class="form-control">
                                ...
                                <div class="full-width">
                                    ...
                                    <button type="submit" value="Thêm sản phẩm" name="btn_insert" class="btn btn-primary">Thêm Sản Phẩm</button>
                                </div>
                        </div>
