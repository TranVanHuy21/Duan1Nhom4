                ...
                <form action="?act=updateProduct&id=<?= $products['id'] ?>" class="update" method="post"
                    ...
                    <div class="form-group">
                        ...
                        <div>
                            ...
                            <input type="text" id="Os"  class="form-control" name="Os" value="<?= htmlspecialchars($products['Os'] ?? '') ?>">
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <input type="text" class="form-control"  id="Camera_secondary" name="Camera_secondary"
