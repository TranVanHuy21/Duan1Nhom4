                                ...
                                <div class="card card-primary">
                                    ...
                                    <div class="box-views">
                                        ...
                                        <div class="content">
                                            ...
                                            <form action="?act=updateProduct&id=<?= $products['id'] ?>" class="update"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        ...
                                                        <input type="number" id="Quanlity" class="form-control"
                                                            name="Quanlity"
                                                    ...
                                                    <div>
                                                        ...
                                                        <input type="text" id="Cpu_speed" class="form-control"
                                                            name="Cpu_speed"
